...
<body class="hold-transition sidebar-mini">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function refresh_inbox() {
				...
				$.ajax({
					...
					success: function(result) {
						...
						display_inbox_emails(account_id);
					}
				});
			...
			$(document).on('click', '.refresh_inbox', refresh_inbox);
				...
				if(account_id != '') {
					if(q == '') {
						$.ajax({
							...
							data: JSON.stringify({ 'action' : 'get_inbox', 'mailbox' : 'inbox', 'account_id' : account_id, 'user_id' : user_info.id, 'page' : page, 'per_page_record' : per_page_record }),
							success: function(result) {
								inbox = result;
								$('#loader').hide();
							}
						...
						$.ajax({
							...
							data: JSON.stringify({ 'action' : 'get_inbox', 'mailbox' : 'inbox', 'account_id' : account_id, 'user_id' : user_info.id, 'page' : page, 'per_page_record' : per_page_record, 'q':q }),
							success: function(result) {
								inbox = result;
								$('#loader').hide();
							}
