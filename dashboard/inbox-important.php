	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			if(user_info.user_role.inbox.read == 1) {
				...
				$('#main_account_select').html("<option values=''>You're not allowed to read accounts</option>");
			}
				...
				if(account_id != '') {
					if(q == '') {
						$.ajax({
							...
							data: JSON.stringify({ 'action' : 'get_important', 'mailbox' : 'inbox', 'account_id' : account_id, 'user_id' : user_info.id, 'page' : page, 'per_page_record' : per_page_record }),
							success: function(result) {
								inbox = result;
								$('#loader').hide();
							}
						...
						$.ajax({
							...
							data: JSON.stringify({ 'action' : 'get_important', 'mailbox' : 'inbox', 'account_id' : account_id, 'user_id' : user_info.id, 'page' : page, 'per_page_record' : per_page_record, 'q':q }),
							success: function(result) {
								inbox = result;
								$('#loader').hide();
							}
