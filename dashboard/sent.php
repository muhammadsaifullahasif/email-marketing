						...
						<div class="col-12">
							<div class="card">
								<div class="card-header row align-items-center justify-content-between">
									<div class="col-md-6">
										<h5 class="card-heading d-inline">Sent</h5>
									</div>
									<div class="col-md-6">
				...
				if(account_id != '') {
					if(q == '') {
						$.ajax({
							...
							data: JSON.stringify({ 'action' : 'get_sent', 'mailbox' : 'sent', 'account_id' : account_id, 'user_id' : user_info.id, 'page' : page, 'per_page_record' : per_page_record }),
							success: function(result) {
								inbox = result;
								$('#loader').hide();
							}
						...
						$.ajax({
							...
							data: JSON.stringify({ 'action' : 'get_sent', 'mailbox' : 'sent', 'account_id' : account_id, 'user_id' : user_info.id, 'page' : page, 'per_page_record' : per_page_record, 'q':q }),
							success: function(result) {
								inbox = result;
								$('#loader').hide();
							}
