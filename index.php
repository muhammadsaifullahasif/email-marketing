...
<body data-theme-mode-panel-active data-theme="light" style="font-family: 'Mazzard H';">
						...
						<nav class="menu-block" id="append-menu-header">
							...
							<ul class="site-menu-main">
								<li class="nav-item nav-item-has-children">
									<a href="#" class="nav-link-item drop-trigger">Dropdowns <i class="fas fa-angle-down"></i></a>
									<ul class="sub-menu" id="submenu-9">
										<li class="sub-menu--item"><a href="#">Dropdown 01</a></li>
										<li class="sub-menu--item"><a href="#">Dropdown 02</a></li>
										<li class="sub-menu--item"><a href="#">Dropdown 03</a></li>
										<li class="sub-menu--item"><a href="#">Dropdown 04</a></li>
									</ul>
								</li>
								<li class="nav-item"><a href="#" class="nav-link-item">Blog</a></li>
								<li class="nav-item"><a href="https://uxtheme.net/product-support/" class="nav-link-item">Support</a></li>
							</ul>
						</nav>
					</div>
					<div class="header-btn header-btn-l-14 ms-auto d-none d-xs-inline-flex">
						<a target="_blank" class="btn btn trail-btn focus-reset" href="https://finestdevs.com/shade/">Start free trail</a>
					</div>
					<!-- mobile menu trigger -->
			...
			<div class="row align-items-center justify-content-center">
				<div class="col-xl-4 col-lg-6 col-md-8 col-sm-10 order-lg-1 order-1" data-aos="fade-right" data-aos-duration="1200" data-aos-once="true">
					<div class="h-100 section-heading-8 content text-lg-start text-center">
						...
						<p>Create custom landing pages with Shades that convert more visitors than any website—no coding required.</p>
						<a href="#" class="btn focus-reset">Get Started Now<i class="fas fa-angle-right"></i></a>
					</div>
				</div>
			...
			<div class="row features-area-l-14 justify-content-center mx-0">
				<div class="col-lg-6 col-md-8 col-sm-10 px-lg-6" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
					<div class="content-area  d-flex">
						...
						<div class="content-body pl-sm-14 pl-5">
							<h5>Easy to use</h5>
							<p class="mb-0">Event is not like most tech conferences. We want our presentations to engage the audience, spark discussion and inspire new ideas.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-8 col-sm-10" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
					<div class="content-area  d-flex ">
						...
						<div class="content-body">
							<h5>Easy to Use</h5>
							<p class="mb-0">Event is not like most tech conferences. We want our presentations to engage the audience, and inspire new ideas.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-8 col-sm-10" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
					<div class="content-area  d-flex ">
						...
						<div class="content-body">
							<h5>Easy to Use</h5>
							<p class="mb-0">Event is not like most tech conferences. We want our presentations to engage the audience.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-8 col-sm-10" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
	...
	<div class="pricing-area-l14 position-relative overflow-hidden z-index-1">
		<div class="container">
			...
			<div class="row justify-content-center" id="table-price-value" data-pricing-dynamic data-value-active="monthly">
				...
				<div class="col-md-12 col-sm-8 l-14-pricing-table row no-gutters" id="pricing_table">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			// var id = 1;
			var obj = { "action" : "display_subscriptions" };
			...
			$.ajax({
				...
				success: function(result) {
					...
					$.each(result, function(key, value){
						var features = '';
						var recommended_box_class = '';
						var recommended_btn_class = '';

						if(value.recommend == 1) {
							recommended_box_class += 'popular-pricing popular-pricing-2';
							recommended_btn_class += 'price-btn-bro';
						} else {
							recommended_box_class += '';
							recommended_btn_class += '';
						}

						if(value.features.email_accounts.limit != false) {
							if(value.features.email_accounts.limit == -1) {
								features += '<li>Unlimited '+ value.features.email_accounts.title +'</li>';
							} else {
								features += '<li>'+ value.features.email_accounts.limit +' '+ value.features.email_accounts.title +'</li>';
							}
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.email_accounts.title +'</li>';
						}

						if(value.features.tracking_email.limit != false) {
							if(value.features.tracking_email.limit == -1) {
								features += '<li>Unlimited '+ value.features.tracking_email.title +'</li>';
							} else {
								features += '<li>'+ value.features.tracking_email.limit +' '+ value.features.tracking_email.title +'/Account/Month</li>';
							}
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.tracking_email.title +'</li>';
						}

						if(value.features.urgent_email.limit != false) {
							if(value.features.urgent_email.limit == -1) {
								features += '<li>Unlimited '+ value.features.urgent_email.title +'</li>';
							} else {
								features += '<li>'+ value.features.urgent_email.limit +' '+ value.features.urgent_email.title +'/Account/Month</li>';
							}
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.urgent_email.title +'</li>';
						}

						if(value.features.staff_accounts.limit != false) {
							if(value.features.staff_accounts.limit == -1) {
								features += '<li>Unlimited '+ value.features.staff_accounts.title +'</li>';
							} else {
								features += '<li>'+ value.features.staff_accounts.limit +' '+ value.features.staff_accounts.title +'</li>';
							}
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.staff_accounts.title +'</li>';
						}

						if(value.features.email_templates.limit != false) {
							if(value.features.email_templates.limit == -1) {
								features += '<li>Unlimited '+ value.features.email_templates.title +'</li>';
							} else {
								features += '<li>'+ value.features.email_templates.limit +' '+ value.features.email_templates.title +'</li>';
							}
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.email_templates.title +'</li>';
						}

						if(value.features.dynamic_email.limit != false) {
							if(value.features.dynamic_email.limit == -1) {
								features += '<li>Unlimited '+ value.features.dynamic_email.title +'</li>';
							} else {
								features += '<li>'+ value.features.dynamic_email.limit +' '+ value.features.dynamic_email.title +'/Account/Month</li>';
							}
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.dynamic_email.title +'</li>';
						}

						if(value.features.api_integration.limit != false) {
							features += '<li>'+ value.features.api_integration.title +'</li>';
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.api_integration.title +'</li>';
						}

						if(value.features.campaigns.limit != false) {
							if(value.features.campaigns.limit == -1) {
								features += '<li>Unlimited '+ value.features.campaigns.title +'</li>';
							} else {
								features += '<li>'+ value.features.campaigns.limit +' '+ value.features.campaigns.title +'</li>';
							}
						} else {
							features += '<li><i class="fas fa-times" style="color: #f00; margin-right: 0.25rem;"></i>'+ value.features.campaigns.title +'</li>';
						}

						$('#pricing_table').append(
							'<div class="col-lg-3 col-md-6 border p-0">' + 
								'<!-- single-price start -->' + 
								'<div class="single-price bg-default text-center '+ recommended_box_class +' pt-5 pb-10 mb-lg-0" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">' + 
									'<!-- price-top start -->' + 
									...
									'<div class="main-price pb-8 border-bottom">' + 
										'<div class="price mt-3 mb-3 position-relative">' + 
											'<span class="d-inline-block mb-0  dynamic-value">'+ value.price.currency.symbol +'</span>' + 
											'<h2 class="d-inline-block mb-0  dynamic-value" data-active="15" data-monthly="'+ value.price.monthly.price +'" data-yearly="'+ value.price.yearly.price +'"></h2>' + 
										'</div>' + 
										'<span class=" dynamic-value" data-active="per month" data-monthly="'+ value.price.monthly.title +'" data-yearly="'+ value.price.yearly.title +'"></span>' + 
									'</div>' + 
									'<!-- main-price end -->' + 
									'<!-- price-body start -->' + 
									'<div class="price-body">' + 
										...
										'</ul>' + 
									'</div>' + 
									'<div class="price-btn '+ recommended_btn_class +'">' + 
										'<a class="btn focus-reset" href="cart.php?id='+ value.id +'">Get started now</a>' + 
									'</div>' + 
									'<!-- price-btn end -->' + 
								'</div>' + 
								'<!-- single-price end -->' + 
